...
function AboutSection() {
  return (
    <section id="about" style={{ position:"relative",background:"#050505",color:"#fff",padding:"96px 56px",overflow:"hidden" }}>
      <div style={{ position:"absolute",top:0,right:0,width:640,height:640,background:"radial-gradient(circle closest-side at center, rgba(232,112,42,0.30) 0%, rgba(232,112,42,0.10) 45%, rgba(232,112,42,0) 100%)",pointerEvents:"none" }} />
...
function ExperienceSection() {
  return (
    <section id="experience" style={{ position:"relative",background:"#000",color:"#fff",padding:"96px 56px",overflow:"hidden" }}>
      <div style={{ position:"absolute",bottom:0,left:0,width:640,height:640,background:"radial-gradient(circle closest-side at center, rgba(232,112,42,0.26) 0%, rgba(232,112,42,0.08) 45%, rgba(232,112,42,0) 100%)",pointerEvents:"none" }} />
